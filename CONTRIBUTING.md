...
Thank you for your interest in contributing to Hive! This document provides guidelines and instructions for contributing to our collection of specialized Claude sub-agents.
...
cd Hive
git remote add upstream https://github.com/Jiangzhewen/Hive.git
```
...
Thank you for contributing to Hive! Your expertise helps make Claude Code more powerful for everyone. 🚀